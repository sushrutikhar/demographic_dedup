// Stanford Classifier, Classify - a multiclass maxent classifier
...
/**
 * Classify provides a command-line interface for doing
 ...
 * <p/>
 * You can also use Classify programmatically, where its main
 ...
 * Typical usage:
 * <p><code>
 * java edu.stanford.nlp.classify.Classify -prop propFile
 * </code><p>or<p>
 * <code>java -mx300m edu.stanford.nlp.classify.Classify
...
public class Classify {
  ...
  public final Flags globalFlags; // simply points to flags[0]
   ...
   */
  private String writeAnswer(String[] strs, String clAnswer, Distribution<String> cntr, Counter<String> contingency, Classifier<String,String> c, double sim) {
  ...
  private ArrayList<String> readAndTestExamples(Classifier<String,String> cl, String filename) {
    if (globalFlags.printFeatures != null) {
    ...
    for (int i = 0; i < test.size(); i++) {
      ...
      output.add(writeAnswer(simpleLineInfo, answer, dist, contingency, cl, sim));
   ...
   *
   * @param props Properties, with the special format of column.flag used in Classify
   ...
   *               See the class documentation for details of the properties.
   */
  public Classify(Properties props) {
  ...
  /**
   * Runs the Classify from the command-line.  Usage: <p><code>
   * java edu.stanford.nlp.classify.Classify -trainFile trainFile
   * -testFile testFile [-useNGrams|-useString|-sigma sigma|...]
   * </code><p>or<p><code>
   * java Classify -prop propFile
   * </code>
   *
  ...
  public boolean trainClassifier() throws IOException {
    ...
    if ((testFile == null && serializeTo == null) || trainFile == null) {
      System.err.println("usage: java edu.stanford.nlp.classify.Classify -prop propFile");
  ...
  public ArrayList<String> testClassifier(String testFile) {
    ...
    return readAndTestExamples(classifier, testFile);
